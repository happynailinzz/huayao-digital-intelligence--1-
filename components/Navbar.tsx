...
const NAV_ITEMS: NavItem[] = [
    ...
    { label: '资料导航', href: '/report-library' },
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex items-center justify-between h-20">
                    ...
                    >
                        ...
                        <svg viewBox="0 0 100 100" className="h-9 w-9" xmlns="http://www.w3.org/2000/svg" aria-label="寰曜数智 Logo">
                            {/* Top Left: Light Gray */}
                        ...
                        <span className={`font-bold text-xl tracking-tight font-sans transition-colors ${logoTextClass}`}>寰曜数智</span>
                    </div>
